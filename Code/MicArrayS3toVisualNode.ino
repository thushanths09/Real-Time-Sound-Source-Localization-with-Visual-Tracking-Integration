...
void gccphat_task(void *p) {
    ...
    while (1) {
        ...
        // --- OLD DEBUG OUTPUT (COMMENTED OUT: breaks Python parser) ---
        // Serial.println("========================================");
        ...
        // --- NEW SERIAL OUTPUT (PYTHON / VISION PIPELINE) ---
        // Format: A,<angle_deg>,<lag_samples>,<rms>
        Serial.printf("A,%.2f,%.2f,%.0f\n", angle, lag_smoothed, rms);

        // Output rate control (10 Hz)
